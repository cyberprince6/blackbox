...
print("  \_/\_/  \___||_|\__|\___/|_|_|_| \___|   \__|\___/  |___/|_|\__,_|\__| |_\_\ |_.__/\___//_\_\ ")
...
raw = input("Choose your desired Option : ")

#First case
if raw == "1" :
    
  echo" enter the ports numbers to scan"
     
    try:
        x= PrettyTable(["scanner"])
...
x=PrettyTable(['email grabbing from an url'])
   
print("use regpy.emails(data) for email")

print("use regpy.url(data) for url email grabbing")
...
#Sixth case
    	 ...
    	 x=PrettyTable(['running services'])
